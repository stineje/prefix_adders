...
# Perl script to generate Han-Carlson prefix adder
...
# -----------------------------------------------------------
# print top modudel
printf("// Han-Carlson Prefix Adder\n\n");
if(length($MODULE)==0){
...
# prefix tree
printf("\n// prefix tree\n");
printf("\t han_carlson prefix_tree(h, c, p, g, sum, cout);\n\n",$XBITS-1,$XBITS-1);


printf("endmodule\n\n");


printf("module han_carlson (h, c, p, g, sum, cout);\n");
printf("\t\n");
printf("\tinput [%s:0] p;\n",$XBITS);
printf("\tinput [%s:0] g;\n",$XBITS);
printf("\toutput [%s:1] h;\n",$XBITS);
...
# Generate the Han-Carlson parallel-prefix tree
# -----------------------------
print "\t// parallel-prefix, Han-Carlson\n";
