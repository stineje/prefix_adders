...
# Perl script to generate Kogge-Stone prefix adder
...
# -----------------------------------------------------------
# print top modudel
printf("// Kogge-Stone Prefix Adder\n\n");
if(length($MODULE)==0){
...
# prefix tree
printf("\n// prefix tree\n");
printf("\t kogge_stone prefix_tree(h, c, p, g, sum, cout);\n\n",$XBITS-1,$XBITS-1);


printf("endmodule\n\n");


printf("module kogge_stone (h, c, p, g, sum, cout);\n");
printf("\t\n");
printf("\tinput [%s:0] p;\n",$XBITS);
printf("\tinput [%s:0] g;\n",$XBITS);
printf("\toutput [%s:1] h;\n",$XBITS);
...
# Generate the Kogge-Stone parallel-prefix tree
# -----------------------------
print "\t// parallel-prefix, Kogge-Stone\n";
